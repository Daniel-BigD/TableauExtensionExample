...
window['tableau'] = /******/ (function(modules) {
    // webpackBootstrap
    /******/ // The module cache
    ...
    /******/
    /******/ /******/ __webpack_require__.p = '/dist-extensions/'; // Load entry module and return exports
    /******/
    ...
    /******/ [
                ...
                ServiceRegistryImpl.prototype.getService = function(serviceName) {
                    if (!this._services.hasOwnProperty(serviceName)) {
                        throw new TableauError_1.TableauError(
                            SharedApiExternalContract_1.ErrorCodes.InternalError,
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var ErrorHelpers = /** @class */ (function() {
                ...
                ErrorHelpers.verifyParameter = function(argumentValue, argumentName) {
                    if (argumentValue === null || argumentValue === undefined) {
                        throw new TableauError_1.TableauError(
                            SharedApiExternalContract_1.ErrorCodes.InvalidParameter,
                ...
                ErrorHelpers.verifyEnumValue = function(enumValue, enumType) {
                    ...
                    if (!isValid) {
                        throw new TableauError_1.TableauError(
                            SharedApiExternalContract_1.ErrorCodes.InvalidParameter,
                            enumValue + ' is invalid value for enum: ' + enumType
                        );
                    }
                };
                /**
            ...
            var InternalToExternalEnumMappings = /** @class */ (function() {
                ...
                InternalToExternalEnumMappings.fieldAggregationType = new EnumConverter_1.EnumConverter(
                    ...
                    (_d[api_internal_contract_js_1.FieldAggregationType.Kurtosis] =
                        SharedApiExternalContract_1.FieldAggregationType.Kurtosis),
                    ...
                    (_d[api_internal_contract_js_1.FieldAggregationType.MonthYear] =
                        SharedApiExternalContract_1.FieldAggregationType.MonthYear),
                    ...
                    (_d[api_internal_contract_js_1.FieldAggregationType.Skewness] =
                        SharedApiExternalContract_1.FieldAggregationType.Skewness),
                    ...
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncDay] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncDay),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncHour] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncHour),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncMinute] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncMinute),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncMonth] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncMonth),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncQtr] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncQtr),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncSecond] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncSecond),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncWeek] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncWeek),
                    (_d[api_internal_contract_js_1.FieldAggregationType.TruncYear] =
                        SharedApiExternalContract_1.FieldAggregationType.TruncYear),
                    ...
                    (_d[api_internal_contract_js_1.FieldAggregationType.Weekday] =
                        SharedApiExternalContract_1.FieldAggregationType.Weekday),
                ...
                InternalToExternalEnumMappings.dashboardObjectType = new EnumConverter_1.EnumConverter(
                    ...
                    (_g[api_internal_contract_js_1.DashboardObjectType.Extension] =
                        SharedApiExternalContract_1.DashboardObjectType.Extension),
                    ...
                    (_g[api_internal_contract_js_1.DashboardObjectType.PageFilter] =
                        SharedApiExternalContract_1.DashboardObjectType.PageFilter),
                    (_g[api_internal_contract_js_1.DashboardObjectType.ParameterControl] =
                        SharedApiExternalContract_1.DashboardObjectType.ParameterControl),
                    (_g[api_internal_contract_js_1.DashboardObjectType.QuickFilter] =
                        SharedApiExternalContract_1.DashboardObjectType.QuickFilter),
                    ...
                    (_g[api_internal_contract_js_1.DashboardObjectType.Worksheet] =
                        SharedApiExternalContract_1.DashboardObjectType.Worksheet),
                    _g)
                );
                ...
                InternalToExternalEnumMappings.errorCode = new EnumConverter_1.EnumConverter(
                    ...
                    (_o[api_internal_contract_js_1.ErrorCodes.PRES_MODEL_PARSING_ERROR] =
                        SharedApiExternalContract_1.ErrorCodes.InternalError),
                    ...
                    (_o[api_internal_contract_js_1.ErrorCodes.VERSION_NOT_CONFIGURED] =
                        SharedApiExternalContract_1.ErrorCodes.APINotInitialized),
                    _o)
                );
            ...
            var ServiceImplBase = /** @class */ (function() {
                ...
                ServiceImplBase.prototype.execute = function(verb, params) {
                    return this._dispatcher.execute(verb, params).catch(function(error) {
                        ...
                        var externalErrorCode = InternalToExternalEnumMappings_1.InternalToExternalEnumMappings.errorCode.convert(
            ...
            var EventListenerManager = /** @class */ (function() {
                ...
                EventListenerManager.prototype.addEventListener = function(eventType, handler) {
                    if (!this._eventListenerManagers.hasOwnProperty(eventType)) {
                        throw new TableauError_1.TableauError(
                            Contract.ErrorCodes.UnsupportedEventName,
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var Column = /** @class */ (function() {
                function Column(
                    _fieldName,
                    _dataType, // TODO: this shoudl be an enum type
                    _isReferenced,
                    _index
                ) {
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var DataSourceImpl = /** @class */ (function() {
                ...
                DataSourceImpl.prototype.refreshAsync = function() {
                    var dataSourceService = ServiceRegistry_1.ApiServiceRegistry.instance.getService(
        ...
        /***/ function(module, exports, __webpack_require__) {
            module.exports =
                ...
                !__webpack_require__(27)(function() {
                    return (
                        Object.defineProperty(__webpack_require__(28)('div'), 'a', {
                            get: function() {
                                return 7;
                            }
                        }).a != 7
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var ExtensionsImpl = /** @class */ (function() {
                    ...
                    if (!this._initializationPromise) {
                        this._initializationPromise = new Promise(function(resolve, reject) {
                            ...
                            if (api_internal_contract_js_1.InternalApiDispatcherHolder.hasDesktopApiDispatcherPromise()) {
                                ...
                                desktopDispatcherPromise
                                    .then(function(dipatcherFactory) {
                                ...
                                ApiShared_1.doCrossFrameBootstrap(window, api_internal_contract_js_1.INTERNAL_CONTRACT_VERSION)
                ...
                ExtensionsImpl.prototype.onDispatcherReceived = function(dispatcherFactory, isExtensionDialog, contextMenuFunctions) {
                    ...
                    var initializationService = ApiShared_1.ApiServiceRegistry.instance.getService(
                        'InitializationService' /* InitializationService */
                    );
                    var callbackMapKeys = contextMenuFunctions ? Object.keys(contextMenuFunctions) : [];
                    return initializationService
                        .initializeDashboardExtensionsAsync(isExtensionDialog, callbackMapKeys)
                        .then(function(result) {
                            if (!result.extensionInstance.locator.dashboardPath) {
                                throw new ApiShared_2.TableauError(
                                    ExtensionsApiExternalContract_1.ErrorCodes.InternalError,
                ...
                ExtensionsImpl.prototype.initializeContextMenuCallbacks = function(contextMenuFunctions) {
                    ...
                    notificationService.registerHandler(
                        api_internal_contract_js_1.NotificationId.ContextMenuClick,
                        function(model) {
                        ...
                        function(event) {
                            ...
                            if (contextMenuFunctions) {
                                if (!contextMenuFunctions[event.id]) {
                                    throw new ApiShared_2.TableauError(
                                        ExtensionsApiExternalContract_1.ErrorCodes.InternalError,
                                        'Received unexpected context menu Id from event: ' + event.id
                                    );
                                }
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function CreateVersionConverter(externalMajorVersion, platformMajorVersion) {
                if (
                    !Number.isInteger(externalMajorVersion) ||
                ...
                return new StackingVersionConverter_1.StackingVersionConverter(
                    externalMajorVersion,
                    platformMajorVersion,
            ...
            var StackingVersionConverter = /** @class */ (function() {
                ...
                function StackingVersionConverter(
                    ...
                    if (this._externalMajorVersion > this._platformMajorVersion) {
                        throw new Error(
                            'Cannot convert between external version ' + this._externalMajorVersion + ' and ' + this._platformMajorVersion
                        );
                    }
                }
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var CrossFrameMessenger = /** @class */ (function() {
                ...
                CrossFrameMessenger.prototype.startListening = function() {
                    ...
                    if (!this.unregisterFunction) {
                        ...
                        this.unregisterFunction = function() {
                            return _this.thisWindow.removeEventListener('message', boundHandler_1, true);
                        };
                    }
                };
                ...
                CrossFrameMessenger.prototype.prepareMessage = function(msg) {
                    ...
                    var preparedMessage = new CrossFramePreparedMessage_1.CrossFramePreparedMessage(
                        msg,
                        this.otherWindow,
            ...
            var DashboardImpl = /** @class */ (function(_super) {
                ...
                function DashboardImpl(_info, _sheetPath) {
                    var _this =
                        _super.call(
                            this,
                            new SheetInfoImpl_1.SheetInfoImpl(
                                _info.name,
                                Contract.SheetType.Dashboard,
                                new Size_1.Size(_info.size.h, _info.size.w)
                            )
                        ) || this;
                    _this._info = _info;
                ...
                DashboardImpl.prototype.initializeWithPublicInterfaces = function(dashboard) {
                    ...
                    for (var _i = 0, _a = this._info.zones; _i < _a.length; _i++) {
                        ...
                        var dashboardObject = new DashboardObject_1.DashboardObject(
                            dashboard,
                            InternalToExternalEnumMappings_1.InternalToExternalEnumMappings.dashboardObjectType.convert(zone.zoneType),
                            zonePoint,
                            zoneSize,
                            worksheet
                        );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var Worksheet = /** @class */ (function(_super) {
                ...
                function Worksheet(_worksheetImpl) {
                    ...
                    _this._worksheetImpl.initializeEvents(_this).forEach(function(e) {
                        return _this.addNewEventType(e);
                    });
                    return _this;
                }
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var WorksheetImpl = /** @class */ (function(_super) {
                ...
                WorksheetImpl.prototype.initializeEvents = function(worksheet) {
                    ...
                    try {
                        notificationService = ServiceRegistry_1.ApiServiceRegistry.instance.getService(
                    ...
                    notificationService.registerHandler(
                        ...
                        function(viz) {
                            marksEvent.triggerEvent(function() {
                                return new MarksSelectedEvent_1.MarksSelectedEvent(worksheet);
                            });
                        }
                    );
                    ...
                    notificationService.registerHandler(
                        ...
                        function(event) {
                            filterEvent.triggerEvent(function() {
                                return new FilterChangedEvent_1.FilterChangedEvent(worksheet, event.fieldName);
                            });
                        }
                    );
            ...
            var FilterChangedEvent = /** @class */ (function(_super) {
                ...
                FilterChangedEvent.prototype.getFilterAsync = function() {
                    ...
                    return this._worksheet.getFiltersAsync().then(function(filters) {
                        ...
                        var eventedFilter = filters.find(function(filter) {
                            return filter.fieldName === _this._fieldName;
                        });
                        if (!eventedFilter) {
                            // We shouldn't hit this unless the filter was removed from the worksheet
                            // after the event was raised.
                            throw new TableauError_1.TableauError(
                                Contract.ErrorCodes.MissingFilter,
                                'cannot find filter: ' + _this._fieldName
                            );
                        }
                    ...
                    messenger.setCommandResponseMessageHandler(function(msg) {
                        ...
                        if (msg.commandGuid === initializationMessage.messageGuid) {
                            ...
                            var dispatcherFactory = function() {
                                return new CrossFrameDispatcher_1.CrossFrameDispatcher(messenger);
                            };
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var CrossFrameDispatcher = /** @class */ (function() {
                ...
                CrossFrameDispatcher.prototype.unregisterNotificationHandler = function(handler) {
                    this._notificationHandlers = this._notificationHandlers.filter(function(h) {
                        return h !== handler;
                    });
                };
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function registerAllSharedServices(dispatcher) {
                ServiceRegistry_1.ApiServiceRegistry.instance.registerService(
                    new DataSourceServiceImpl_1.DataSourceServiceImpl(dispatcher)
                );
                ...
                ServiceRegistry_1.ApiServiceRegistry.instance.registerService(
                    new ParametersServiceImpl_1.ParametersServiceImpl(dispatcher)
                );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var DataSourceServiceImpl = /** @class */ (function(_super) {
                ...
                DataSourceServiceImpl.prototype.getActiveTablesAsync = function(dataSourceId) {
                    ...
                    return this.execute(api_internal_contract_js_1.VerbId.GetActiveTables, joinParameters).then(function(joinResponse) {
                        ...
                        if (tableInfos.tables.length === 0) {
                            throw new TableauError_1.TableauError(
                                SharedApiExternalContract_1.ErrorCodes.UnsupportedMethodForDataSourceType,
                ...
                DataSourceServiceImpl.prototype.getConnectionSummariesAsync = function(dataSourceId) {
                    ...
                    // Get the description of the tables used by this connection
                    return this.execute(api_internal_contract_js_1.VerbId.GetConnectionDescriptionSummaries, params).then(function(
                        response
                    ) {
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var FilterServiceImpl = /** @class */ (function(_super) {
                ...
                FilterServiceImpl.prototype.applyFilterAsync = function(visualId, fieldName, values, updateType, filterOptions) {
                    ...
                    parameters[
                        api_internal_contract_js_1.ParameterId.FilterUpdateType
                    ] = ExternalToInternalEnumMappings_1.ExternalToInternalEnumMappings.filterUpdateType.convert(updateType);
                ...
                FilterServiceImpl.prototype.applyRangeFilterAsync = function(visualId, fieldName, filterOptions) {
                    ...
                    if (filterOptions.nullOption) {
                        ...
                        ] = ExternalToInternalEnumMappings_1.ExternalToInternalEnumMappings.nullOptions.convert(filterOptions.nullOption);
                    } else {
                ...
                FilterServiceImpl.prototype.getCategoricalDomainAsync = function(worksheetName, fieldId, domainType) {
                    ...
                    parameters[
                        api_internal_contract_js_1.ParameterId.DomainType
                    ] = ExternalToInternalEnumMappings_1.ExternalToInternalEnumMappings.filterDomainType.convert(domainType);
                    return this.execute(verb, parameters).then(function(response) {
                ...
                FilterServiceImpl.prototype.convertRelativeDateFilter = function(domainFilter) {
                    var anchorDateValue = new GetDataModels_1.DataValue(
                        domainFilter.anchorDate.value,
                        domainFilter.anchorDate.formattedValue
                    );
                    return new FilterModels_1.RelativeDateFilter(
                        ...
                        anchorDateValue,
                        InternalToExternalEnumMappings_1.InternalToExternalEnumMappings.dateStepPeriod.convert(domainFilter.periodType),
                        InternalToExternalEnumMappings_1.InternalToExternalEnumMappings.dateRangeType.convert(domainFilter.rangeType),
                        domainFilter.rangeN
                    );
                };
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var ExternalToInternalEnumMappings = /** @class */ (function() {
                ...
                ExternalToInternalEnumMappings.nullOptions = new EnumConverter_1.EnumConverter(
                    ...
                    (_b[SharedApiExternalContract_1.FilterNullOption.NonNullValues] =
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var GetDataServiceImpl = /** @class */ (function(_super) {
                ...
                GetDataServiceImpl.prototype.getUnderlyingDataAsync = function(
                    ...
                    var verb =
                        getType === GetDataService_1.GetDataType.Summary
                            ? api_internal_contract_js_1.VerbId.GetDataSummaryData
                            : api_internal_contract_js_1.VerbId.GetUnderlyingData;
                    var requestMaxRows =
                        verb === api_internal_contract_js_1.VerbId.GetUnderlyingData ? this.getLimitedMaxRows(maxRows) : maxRows;
                    var parameters = {};
                    parameters[api_internal_contract_js_1.ParameterId.VisualId] = visualId;
                ...
                GetDataServiceImpl.prototype.processResultsTable = function(responseData, isSummary) {
                    var headers = responseData.headers.map(function(h) {
                        return new GetDataModels_1.Column(h.fieldCaption, h.dataType, h.isReferenced, h.index);
                    });
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var ParametersServiceImpl = /** @class */ (function(_super) {
                ...
                ParametersServiceImpl.prototype.getParametersForSheetAsync = function(sheetPath, sheet) {
                    var parameters = ((_a = {}), (_a[api_internal_contract_js_1.ParameterId.SheetPath] = sheetPath), _a);
            ...
            var ParameterImpl = /** @class */ (function() {
                ...
                Object.defineProperty(ParameterImpl.prototype, 'currentValue', {
                    get: function() {
                        return new GetDataModels_1.DataValue(
                            this._parameterInfo.currentValue.value,
                            this._parameterInfo.currentValue.formattedValue
                        );
                    },
                    enumerable: true,
                    configurable: true
                ...
                ParameterImpl.prototype.initializeEvents = function(sheet) {
                    ...
                    notificationService.registerHandler(
                        ...
                        function(fieldName) {
                            parameterEvent.triggerEvent(function() {
                                return new ParameterChangedEvent_1.ParameterChangedEvent(fieldName, sheet);
                            });
                        }
                    );
                ...
                ParameterImpl.prototype.setParameterInfo = function(parameterInfo) {
                    ...
                    var type = InternalToExternalEnumMappings_1.InternalToExternalEnumMappings.allowableValues.convert(
                    ...
                    if (type === Contract.ParameterValueType.List) {
                        ...
                        listValues = values.map(function(val) {
                            return new GetDataModels_1.DataValue(val.value, val.formattedValue);
                        });
                    } else if (type === Contract.ParameterValueType.Range) {
                        minValue =
                            parameterInfo.minValue &&
                            new GetDataModels_1.DataValue(parameterInfo.minValue.value, parameterInfo.minValue.formattedValue);
                        maxValue =
                            parameterInfo.maxValue &&
                            new GetDataModels_1.DataValue(parameterInfo.maxValue.value, parameterInfo.maxValue.formattedValue);
                ...
                ParameterChangedEvent.prototype.getParameterAsync = function() {
                    ...
                    return service.findParameterByGlobalFieldNameAsync(this._globalFieldName, this.sheet).then(function(parameter) {
                        if (parameter === undefined) {
                            throw new TableauError_1.TableauError(
                                Contract.ErrorCodes.MissingParameter,
                                'Cannot find parameter: ' + _this._globalFieldName
                            );
                        }
                        return parameter;
                    });
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var Parameter = /** @class */ (function(_super) {
                ...
                function Parameter(parameterImpl, sheet) {
                    ...
                    _this.parameterImpl.initializeEvents(sheet).forEach(function(e) {
                        return _this.addNewEventType(e);
                    });
                    return _this;
                }
                ...
                SelectionServiceImpl.prototype.selectMarksByValueAsync = function(visualId, selectionCriterias, selectionUpdateType) {
                    ...
                    switch (selectionCriteriaType) {
                        ...
                        case SelectionCriteriaType.RangeType: {
                            parameters[api_internal_contract_js_1.ParameterId.QuantRangeSelectionModels] =
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var Environment = /** @class */ (function() {
                function Environment(extensionEnvironment) {
                    ...
                    this._context = ApiShared_1.InternalToExternalEnumMappings.extensionContext.convert(
                        extensionEnvironment.extensionContext
                    );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var Settings = /** @class */ (function(_super) {
                ...
                function Settings(_settingsImpl) {
                    ...
                    // Initialize our event handling for this class
                    _this._settingsImpl.initializeEvents().forEach(function(e) {
                        return _this.addNewEventType(e);
                    });
                    return _this;
                }
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function registerAllExtensionsServices(dispatcher) {
                ApiShared_1.ApiServiceRegistry.instance.registerService(
            ...
            var UIServiceImpl = /** @class */ (function(_super) {
                ...
                UIServiceImpl.prototype.displayDialogAsync = function(url, payload, options) {
                    ...
                    if (h <= 0 || w <= 0) {
                        throw new ApiShared_1.TableauError(
                            ExtensionsApiExternalContract_1.ErrorCodes.InvalidParameter,
                    ...
                    return this.execute(api_internal_contract_js_1.VerbId.DisplayDialog, parameters).then(function(response) {
                        ...
                        switch (dialogResult) {
                            case api_internal_contract_js_1.ExtensionDialogResult.DialogAlreadyOpen:
                                throw new ApiShared_1.TableauError(
                                    ExtensionsApiExternalContract_1.ErrorCodes.DialogAlreadyOpen,
                            ...
                            case api_internal_contract_js_1.ExtensionDialogResult.InvalidDomain:
                                throw new ApiShared_1.TableauError(
                                    ExtensionsApiExternalContract_1.ErrorCodes.InvalidDomainDialog,
                ...
                UIServiceImpl.prototype.closeDialog = function(payload) {
                    var parameters = payload
                        ? ((_a = {}), (_a[api_internal_contract_js_1.ParameterId.ExtensionDialogPayload] = payload), _a)
                        : {};
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var SettingsImpl = /** @class */ (function() {
                ...
                SettingsImpl.prototype.initializeEvents = function() {
                    ...
                    notificationService.registerHandler(
                        api_internal_contract_js_1.NotificationId.SettingsChanged,
                        function(model) {
                            return true;
                        },
                        function(event) {
                            _this._currentSettings = event.newSettings;
                            settingsChangedEvent.triggerEvent(function() {
                                return new SettingsChangedEvent(event.newSettings);
                            });
                        }
                    );
                ...
                UIImpl.prototype.displayDialogAsync = function(url, payload, options) {
                    ...
                    return new Promise(function(resolve, reject) {
                        uiService
                            ...
                            .then(function() {
                                var unregisterFn = notificationService.registerHandler(
                                    api_internal_contract_js_1.NotificationId.ExtensionDialogUpdate,
                                    function(model) {
                                    ...
                                    function(event) {
                                        if (event.isCloseEvent) {
                                            ...
                                            reject(
                                                new ApiShared_1.TableauError(
                                                    Contract.ErrorCodes.DialogClosedByUser,
